...
public class userManage extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		for(Iterator<user> it = userList.iterator();it.hasNext();){
			...
			out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" height=\"25\"  width=\"35%\">");
			out.println("					");
			//out.println("						<input type=\"button\" value=\"修改\" name=\"username\" id="+s+" onclick=\"javascript:window.location='userModify';\" /> ");
			out.println("						<input type=\"button\" value=\"修改\" name=\"username\" id=\"hahahaha\" onclick=\"javascript:jump(this.id)\"/>");
